...
public abstract class ModelTestConstants extends TestCase {
    ...
    // Matches for testing the detect - process
    ...
    // Matches for testing the forward/forward - scenarios
    ...
    // Matches for testing the backward/backward - scenarios
    ...
    // Matches for testing the forward/backward - scenarios
    ...
    // Matches for testing the backward/forward - scenarios
    public static final Match R16 = new Match(new DNASequence(null), 600, 400, new DNASequence(null), 400, 600);
    public static final Match R17 = new Match(new DNASequence(null), 200, 500, new DNASequence(null), 500, 800);
    public static final Match R18 = new Match(new DNASequence(null), 100, 300, new DNASequence(null), 550, 800);
    public static final Match R19 = new Match(new DNASequence(null), 500, 700, new DNASequence(null), 600, 700);
    public static final Match R20 = new Match(new DNASequence(null), 300, 450, new DNASequence(null), 700, 850);
}
