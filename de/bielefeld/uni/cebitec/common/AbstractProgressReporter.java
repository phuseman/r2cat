 ...
 * 
 * For example this can be used with a SwingWorker task by calling the publish
 * and setProgress methods.
 * 
 * 
 * @author phuseman
 * 
...
public interface AbstractProgressReporter {
	...
	/**
	 * This method updates the progress of the object which implements this in
	 * an appropriate way. The progress is given as double value between 0 and 1
	 * indicating how far the computation is, and a comment string describing
	 * the progress
	 * 
	 * @param percentDone
	 ...
	 *            important.
	 * @param comment
	 *            the comment for this status change. Can be null or empty if
	 *            not needed.
	 */
	abstract void reportProgress(double percentDone, String comment);

	// here is one example to use with a JTextArea progress and a JProgressbar
	// progressBar
	//
	// @Override
	...
	// }
	//
	// the events are then delivered via the process method and with the help of
