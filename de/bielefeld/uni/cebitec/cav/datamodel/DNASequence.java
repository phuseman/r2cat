...
/**
 * This Objects represent DNA sequences typically based on fasta files.
 * Usually this class is used to store the meta information for contigs and/or reference genomes.
 * Some additional functionalities (offset, repetitiveness, reverse complementarity) are helpful when visualizing these sequences.
 * 
 * @author phuseman
 *
 */
public class DNASequence implements Comparable {
	...
	//the id of that sequence (in fasta the first word after a >). it should be unique, however ther is no check implemented.
	...
	//the offset of this sequence, if many sequences were stored in a single file.
	...
	//the percentage of the length of this sequence that occurs more than once on a reference genome
	...
	/**
	 * Creates a new sequence object. At least an unique ID has to be given. However, there is no check that this ID is unique!
	 * @param id
	 */
	...
	/**
	 * Creates a sequence object with unique ID and size of the sequence. There is no check that the ID is unique!
	 * @param id
	 * @param size
	 */
	 ...
	 * @param file that contains the sequence
	 * @param id unique id of this sequence object
	 * @param description description from the fasta file
	...
	/**
	 * @return Get the file wher this sequence can be found.
	 */
	public File getFile() {
		return file;
	}
	...
	/**
	 * @return The offset of this sequence within the fasta file, or within a collection of sequences.
	 */
	public long getOffset() {
		return offset;
	}

	/**Sets the offset within a collection of sequences. There is no check if these offset make sense!
	 * @param offset
	 */
	...
	/**
	 * This has an influence on the display of dotplots or the export of fasta files.
	...
	/**
	 * The sort key should determine how to order a collection of sequences, for example contigs.
	 * @param sortKey
	 */
