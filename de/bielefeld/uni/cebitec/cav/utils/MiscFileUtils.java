...
public class MiscFileUtils {
	...
	/**
	 * Shows a dialog to select files for opening or saving files.
	 * When saving the dialog ask if an existing file should be overwritten. If the user selects not, then
	 * null will be returned instead of the file.
	 * 
	 * @param parent
