...
import de.bielefeld.uni.cebitec.primerdesign.PrimerGenerator;
import de.bielefeld.uni.cebitec.primerdesign.PrimerResult;
import de.bielefeld.uni.cebitec.primerdesign.XMLCheck;
import de.bielefeld.uni.cebitec.primerdesign.gui.PrimerResultFrame;
...
public class PrimerFrame extends JFrame implements ActionListener,
	...
	public PrimerFrame(MatchList matchList) {
		this.matchList = matchList;
		primer = new PrimerTable(matchList);
		// uebpruefen ob leer... dann FILE
		Vector<DNASequence> seq = matchList.getQueries();
		init();
	}
	...
	private void runAlgorithm() throws IOException {
		if (matchList.getQueries() != null
				&& !matchList.getQueries().isEmpty()) {
			contigs = matchList.getQueries().get(0);
		} else {
